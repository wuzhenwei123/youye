	          ...
	          <div class="widget-content">
	            <form class="form-horizontal" method="post" action="#" name="add-form" id="add-form" novalidate="novalidate">
	            	...
	            	<div class="control-group">
		                ...
		                <div class="controls">
		                  <input type="text" name="aException" id="aException"  value="" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">content:</label>
		                <div class="controls">
		                  <input type="text" name="aContent" id="aContent"  value="" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">createTime:</label>
		                <div class="controls">
		                  <input type="text" name="aCreateTime" id="aCreateTime" value="" required onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly"/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">remark:</label>
		                <div class="controls">
		                  <input type="text" name="aRemark" id="aRemark"  value="" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
	            	...
	            	<div class="control-group">
		                ...
		                <div class="controls">
		                  <input type="text" name="aBrief" id="aBrief"  value="" required/>
		            	</div>
		            </div>
	            </form>
	          </div>
