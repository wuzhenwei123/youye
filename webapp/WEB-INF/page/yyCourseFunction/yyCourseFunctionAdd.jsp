...
<head>
	<title>新增yyCourseFunction</title>
	<meta charset="UTF-8" />
	          ...
	          <div class="widget-content">
	            <form class="form-horizontal" method="post" action="#" name="add-form" id="add-form" novalidate="novalidate">
	            	<div class="control-group">
		                ...
		                <div class="controls">
		                  <input type="text" name="aCourse_id" id="aCourse_id"  value="" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">function_id:</label>
		                <div class="controls">
		                  <input type="text" name="aFunction_id" id="aFunction_id"  value="" required/>
		            	</div>
		            </div>
	            </form>
	          </div>
