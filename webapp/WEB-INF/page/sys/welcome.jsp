...
<body style="background:#fff;">
	...
	<script type="text/javascript">
		...
		function searchData(){
			...
			$.getJSON("${ctx}/yyDataAnalysisController/userAnalysis",
	    		{
					year_str:year_str,
					_t: Math.random()
		        },function(data){
	            ...
	            if (result.code == 1) {
	            	...
	            	var option1 = "{title: {text: '"+json.year_str+"年用户数量',left: '50%'},color: ['#feb830'],";
	            	...
	            	option1 = option1 + "series : [{name:'用户数量',label: {normal: {show: true,position: 'top'}},type:'bar',barWidth: '60%',data:["+json.data_str+"]}]}";
	            	console.log(option1);
