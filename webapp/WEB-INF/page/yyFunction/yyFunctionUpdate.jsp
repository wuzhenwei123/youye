	        ...
	        <div class="widget-box">
	          <div class="widget-content nopadding">
	            <form class="form-horizontal" method="post" action="#" name="update-form" id="update-form" novalidate="novalidate">
	            	<input type="hidden" name="mId" id="mId"  value="${yyfunction.id}" required/>
	            	<div class="control-group">
		                <label class="control-label">name:</label>
		                <div class="controls">
		                  <input type="text" name="mName" id="mName"  value="${yyfunction.name}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">parent_id:</label>
		                <div class="controls">
		                  <input type="text" name="mParent_id" id="mParent_id"  value="${yyfunction.parent_id}" required/>
		            	</div>
		            </div>
	            </form>
	          </div>
