	      ...
	      <div class="span12">
	        <div class="widget-box">
	          <div class="widget-content nopadding">
	          	<input type="hidden" id="mMid"value="${columnmethod.mid}" />
	            <form class="form-horizontal" method="post" action="#" name="add-form" id="add-form" novalidate="novalidate">
	              <div class="control-group">
	                ...
	                <div class="controls">
	                  <input type="text" name="mMethodName" id="mMethodName" value="${columnmethod.methodName}" required />
	                </div>
	              </div>
	              <div class="control-group">
	                <label class="control-label">方法路径</label>
	                <div class="controls">
	                  <input type="text" name="mActionPath" id="mActionPath" value="${columnmethod.actionPath}" required />
	                </div>
	              </div>
	            </form>
	          </div>
