	          ...
	          <div class="widget-content nopadding">
	            <form class="form-horizontal" method="post" action="#" name="update-form" id="update-form" novalidate="novalidate">
	            	<div class="control-group">
		                ...
		                <div class="controls">
		                  <input type="text" name="mId" id="mId"  value="${msarea.id}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">areaCode:</label>
		                <div class="controls">
		                  <input type="text" name="mAreaCode" id="mAreaCode"  value="${msarea.areaCode}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">areaName:</label>
		                <div class="controls">
		                  <input type="text" name="mAreaName" id="mAreaName"  value="${msarea.areaName}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">cityCode:</label>
		                <div class="controls">
		                  <input type="text" name="mCityCode" id="mCityCode"  value="${msarea.cityCode}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">alp:</label>
		                <div class="controls">
		                  <input type="text" name="mAlp" id="mAlp"  value="${msarea.alp}" required/>
		            	</div>
		            </div>
	            </form>
	          </div>
