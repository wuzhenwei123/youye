...
<head>
	<title>新增yyCompanyLearnStyle</title>
	<meta charset="UTF-8" />
	          ...
	          <div class="widget-content">
	            <form class="form-horizontal" method="post" action="#" name="add-form" id="add-form" novalidate="novalidate">
	            	<div class="control-group">
		                ...
		                <div class="controls">
		                  <input type="text" name="aCompany_id" id="aCompany_id"  value="" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">learning_style_id:</label>
		                <div class="controls">
		                  <input type="text" name="aLearning_style_id" id="aLearning_style_id"  value="" required/>
		            	</div>
		            </div>
	            </form>
	          </div>
