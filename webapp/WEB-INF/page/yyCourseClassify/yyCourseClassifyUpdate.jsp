	          ...
	          <div class="widget-content nopadding">
	            <form class="form-horizontal" method="post" action="#" name="update-form" id="update-form" novalidate="novalidate">
	            	...
	            	<div class="control-group">
		                ...
		                <div class="controls">
		                  <input type="text" name="mLevel" id="mLevel"  value="${yycourseclassify.level}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">parent_id:</label>
		                <div class="controls">
		                  <input type="text" name="mParent_id" id="mParent_id"  value="${yycourseclassify.parent_id}" required/>
		            	</div>
		            </div>
	            </form>
	          </div>
