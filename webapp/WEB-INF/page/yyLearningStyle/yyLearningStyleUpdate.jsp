	        ...
	        <div class="widget-box">
	          <div class="widget-content nopadding">
	            <form class="form-horizontal" method="post" action="#" name="update-form" id="update-form" novalidate="novalidate">
	            	<input type="hidden" name="mId" id="mId"  value="${yylearningstyle.id}" required/>
	            	<div class="control-group">
		                <label class="control-label">学习风格名称:</label>
		                <div class="controls">
		                  <input type="text" name="mName" id="mName"  value="${yylearningstyle.name}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                ...
		                <div class="controls">
			                <select id="mState" class="select" required> 
		                        <option <c:if test="${yylearningstyle.state== 1}" >selected="selected"</c:if>  value="1">正常</option> 
		                        <option <c:if test="${yylearningstyle.state== 0}" >selected="selected"</c:if> value="0">禁用</option> 
		                	</select> 
		            	</div>
		            </div>
	            </form>
