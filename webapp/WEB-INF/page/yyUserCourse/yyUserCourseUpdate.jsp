	        ...
	        <div class="widget-box">
	          <div class="widget-content nopadding">
	            <form class="form-horizontal" method="post" action="#" name="update-form" id="update-form" novalidate="novalidate">
	            	<input type="hidden" name="mId" id="mId"  value="${yyusercourse.id}" required/>
	            	<div class="control-group">
		                <label class="control-label">user_id:</label>
		                <div class="controls">
		                  <input type="text" name="mUser_id" id="mUser_id"  value="${yyusercourse.user_id}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">course_id:</label>
		                <div class="controls">
		                  <input type="text" name="mCourse_id" id="mCourse_id"  value="${yyusercourse.course_id}" required/>
		            	</div>
		            </div>
	            </form>
	          </div>
