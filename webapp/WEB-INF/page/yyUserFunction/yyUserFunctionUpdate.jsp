	        ...
	        <div class="widget-box">
	          <div class="widget-content nopadding">
	            <form class="form-horizontal" method="post" action="#" name="update-form" id="update-form" novalidate="novalidate">
	            	<input type="hidden" name="mId" id="mId"  value="${yyuserfunction.id}" required/>
	            	<div class="control-group">
		                <label class="control-label">user_id:</label>
		                <div class="controls">
		                  <input type="text" name="mUser_id" id="mUser_id"  value="${yyuserfunction.user_id}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">function_id:</label>
		                <div class="controls">
		                  <input type="text" name="mFunction_id" id="mFunction_id"  value="${yyuserfunction.function_id}" required/>
		            	</div>
		            </div>
	            </form>
	          </div>
