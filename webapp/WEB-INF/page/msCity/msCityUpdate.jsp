	          ...
	          <div class="widget-content nopadding">
	            <form class="form-horizontal" method="post" action="#" name="update-form" id="update-form" novalidate="novalidate">
	            	<div class="control-group">
		                ...
		                <div class="controls">
		                  <input type="text" name="mId" id="mId"  value="${mscity.id}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">cityCode:</label>
		                <div class="controls">
		                  <input type="text" name="mCityCode" id="mCityCode"  value="${mscity.cityCode}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">cityName:</label>
		                <div class="controls">
		                  <input type="text" name="mCityName" id="mCityName"  value="${mscity.cityName}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">provinceCode:</label>
		                <div class="controls">
		                  <input type="text" name="mProvinceCode" id="mProvinceCode"  value="${mscity.provinceCode}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">countryCode:</label>
		                <div class="controls">
		                  <input type="text" name="mCountryCode" id="mCountryCode"  value="${mscity.countryCode}" required/>
		            	</div>
		            </div>
	            	<div class="control-group">
		                <label class="control-label">alp:</label>
		                <div class="controls">
		                  <input type="text" name="mAlp" id="mAlp"  value="${mscity.alp}" required/>
		            	</div>
		            </div>
	            </form>
	          </div>
